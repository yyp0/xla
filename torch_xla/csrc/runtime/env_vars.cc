...
const char* const kEnvPjrtMasterAddr = "MASTER_ADDR";
const char* const kEnvPjrtMasterPort = "MASTER_PORT";
const char* const kEnvPjrtWorldSize = "WORLD_SIZE";
const char* const kEnvPjrtLocalRank = "LOCAL_RANK";
const char* const kEnvPjrtRank = "RANK";
